...
function penci_register_review_scripts() {
	...
	wp_register_script( 'jquery-penci-review', plugin_dir_url( __FILE__ ) . 'js/review.js', array( 'jquery' ), PENCI_REVIEW_VER, true );

    wp_enqueue_script( 'jquery-penci-review' );
...
add_action( 'elementor/widgets/register', function ( $widgets_manager ) {
	...
	$widgets_manager->register( new \PenciReviewElementor() );
} );