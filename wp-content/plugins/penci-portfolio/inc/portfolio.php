...
if ( ! class_exists( 'Penci_Soledad_Portfolio_Shortcode' ) ):
	class Penci_Soledad_Portfolio_Shortcode {
		...
		function portfolio_shortcode( $atts, $content = null ) {
			...
			// Define allowed styles for portfolio items
			$allowed_item_styles = array( 'text_overlay', 'below_img' ); // adjust as needed

			// Validate $item_style
			$item_style = ( isset( $item_style ) && in_array( $item_style, $allowed_item_styles, true ) )
				? $item_style
				: 'text_overlay';
